...
def figure_06_conformal_breaches() -> None:
    ...
    save_figure(fig,"Fig07_conformal_lower_bound_breaches")
...
def figure_07_shap() -> None:
    ...
    save_figure(fig,"Fig08_relative_performance_SHAP")
...
def figure_08_seasonal() -> None:
    ...
    save_figure(fig,"Fig09_seasonal_persistence")
...
def figure_09_field_load() -> None:
    ...
    save_figure(fig,"Fig10_field_load_conditioned_persistence")
...
def figure_10_paired_controls() -> None:
    ...
    save_figure(fig,"Fig11_paired_candidate_control")
